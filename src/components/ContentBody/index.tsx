...
const contentBody: React.FC<any> = (props: any) => {
  ...
  // 判断切换天气组件
  const [readWeatherStateDate, setReadWeatherStateDate] =
    useState<boolean>(true);
  //切换盒子内的内容
  const [changeWeatherBoxContent, setChangeWeatherBoxContent] = useState<any>();
  ...
  const box_content2 = (
    <>
      <div className="icon_weather">
        <div className="icon_weather_content">
  ...
  const box_content1 = (
    <>
      <div className="d_weather">
        <div className="d_weather_content">
          <div className="future_weather animate__animated animate__fadeIn">
            <div>明天</div>
            <div
              className="future_highweather_icon iconfont icon-hongseyuan"
              title="最高温"
            ></div>
            <div>28°C</div>
            <div
              className="future_lowweather_icon iconfont icon-daka"
              title="最低温"
            ></div>
            <div>23°C</div>
            <div>无风</div>
  ...
  const box_content3 = (
    <>
      <div className="h_weather">
        <div className="h_weather_content">小时气温!还未完善</div>
      </div>
    </>
  );
  ...
  return (
    <>
        ...
        <div className="setSize">
          <div className="contentbox">
            <div className="content_left">
              <div className="content_left_box"></div>
            </div>
            <div className="content_right">
              ...
              <div className="content2">
                <div className="content_weather animate__animated animate__fadeIn">
                  {readWeatherStateDate ? (
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${weather_cloud})`,
                    ...
                    >
                      ...
                      <div className="weather_box_p2">
                        <span className="high_wea" onClick={() => {}}>
                          高温 16°C
                        </span>
                        <span className="low_wea" onClick={() => {}}>
                          低温 10°C
                        </span>
                        <span className="note" title="vanilla-tilt">
                          不要被阴云遮住好好心情
                        </span>
                      </div>
                    </div>
                      ...
                      <div className="content_box">
                        <div className="cont_body">
                          <div className="cont_body_head">
                            ...
                            <div className="cont_body_city">金堂县 {'>'}</div>
                          </div>
                        ...
                        <div className="box_show">
                          <div className="box_show_content">
                            ...
                            <div className="box_show_click">
                              ...
                              <div
                                onClick={() => {
                                  setChangeWeatherBoxContent(box_content3);
                                }}
                              ></div>
                            </div>
                          </div>
                ...
                <div className="content_time animate__animated animate__fadeIn"></div>
                <div className="content_text animate__animated animate__fadeIn"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        className="zhezhaoceng"
        style={
          readWeatherStateDate ? { display: 'none' } : { display: 'block' }
        }
      ></div>
    </>
  );
